...
Start with the :ref:`tutorial` — installation, first launch, and a guided
first contact with the add-on.

Looking for a specific task?
----------------------------

Browse the :ref:`how-to` recipes — task-oriented guides grouped by user
goal (import, photogrammetry, digital replica preparation).

Need parameter details?
-----------------------

Consult the :ref:`reference` — panel-by-panel and tool-by-tool description
of every 3DSC capability, plus the changelog appendix.
